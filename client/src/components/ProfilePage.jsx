...
import {Box,Button,Heading,Tabs,TabList,TabPanels,Tab,TabPanel,Input,Checkbox,useDisclosure,Modal,ModalOverlay,ModalContent,ModalHeader,ModalBody,ModalFooter,Flex,VStack,} from '@chakra-ui/react';
  ...
  return (
    <div style={{ minHeight: '100vh' }}>
      <Box p={6} maxW="6xl" mx="auto">
        ...
        <Flex>
          <Box w="20%">
            <Tabs orientation="vertical" variant="soft-rounded" colorScheme="blue" onChange={handleTabChange} index={tabIndex}>
              <TabList>
          ...
          <Box flex="1" ml={6}>
            <Tabs isFitted index={tabIndex}>
              <TabPanels>
                ...
                <TabPanel>
                  <Box border="1px solid #e2e8f0" borderRadius="md" p={4}>
                    <Heading size="md" mb={4}>Filter Websites</Heading>
                    <VStack align="stretch" spacing={3}>
                      <Flex justify="space-between" align="center" border="1px solid #e2e8f0" p={2} borderRadius="md">
